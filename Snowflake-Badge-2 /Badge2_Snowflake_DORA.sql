...
grant usage on function UTIL_DB.PUBLIC.GRADER(VARCHAR, BOOLEAN, NUMBER, NUMBER, VARCHAR) 
to SYSADMIN ;
...
desc function UTIL_DB.PUBLIC.GRADER
...
select * 
   ...
   where account_name = 'ACME' 
   and region like 'GCP_%' 
   and deleted_on is null;-- > this is null so 
