...
SELECT * FROM WEB_SALES WHERE WS_SOLD_DATE_SK = 2450859 AND WS_ITEM_SK IN (286952,286954);
-- Includes one cluster key
SELECT * FROM WEB_SALES WHERE WS_SOLD_DATE_SK = 2450849 AND WS_BILL_HDEMO_SK IN (763, 755);
-- Includes no cluster key
SELECT * FROM WEB_SALES WHERE WS_ITEM_SK =255608 AND WS_BILL_HDEMO_SK IN (763, 755);
